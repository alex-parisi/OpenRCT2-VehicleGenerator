...
`Remap1`/`Remap2`/`Remap3` regions become player-recolorable, `Peep` maps to
its dedicated palette slot, `Mask` materials become transparent cutouts, and so
on. Geometry, textures, and lights are then handed
