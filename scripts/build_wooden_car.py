...
def build_chassis():
    ...
    for x_sign in (-1, +1):
        add_box(
            ...
            center=(
                x_sign * (CHASSIS_LEN / 2 + BUMPER_LEN / 2),
                CHASSIS_Y + CHASSIS_THICK / 2,
                0.0,
            ),
...
def build_body():
    ...
    for z_sign in (-1, +1):
        add_box(
            ...
            center=(0.0, CHASSIS_TOP + SIDE_HEIGHT / 2, z_sign * SIDE_Z),
    ...
    for x_sign in (-1, +1):
        ...
        add_box(
            ...
            center=(end_x, CHASSIS_TOP + END_HEIGHT / 2, 0.0),
...
def build_seats():
    ...
    for label, cx in (("Front", FRONT_BENCH_X), ("Back", BACK_BENCH_X)):
        add_box(
            ...
            center=(cx, CHASSIS_TOP + BENCH_HEIGHT / 2, 0.0),
